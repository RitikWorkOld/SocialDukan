...
public class ShadowTransformerOne implements ViewPager.OnPageChangeListener, ViewPager.PageTransformer{

    private ViewPager viewPager;
    private CardAdapterOne cardAdapter;
    private float lastOffset;
    private boolean scalingEnabled;

    public ShadowTransformerOne(ViewPager viewPager, CardAdapterOne adapter) {
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if (nextCard != null) {
            ...
            nextCard.setCardElevation((baseElevation + baseElevation
                    * (CardAdapterOne.MAX_ELEVATION_FACTOR - 1) * (realOffset)));
        }
