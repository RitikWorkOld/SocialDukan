...
public class School_ten_md {
    ...
    public School_ten_md() {
    }

    public School_ten_md(String schoolboard, String schoolendy, String schoolname, String schoolper, String schoolstarty, String uid) {
